# Tokenki Electron Desktop App

This directory contains the Electron wrapper for Tokenki, providing a native desktop application with system tray support for Windows, macOS, and Linux.
...
```bash
# If you have a pre-built binary (e.g., tokenki-macos)
cp ../tokenki-macos ../tokenki
```
...
- Store database in `../data/tokenki.db`
...
### Database Location
- **Development**: `../data/tokenki.db` (project directory)
- **Production**:
  - macOS: `~/Library/Application Support/Tokenki/data/`
  - Windows: `%APPDATA%/Tokenki/data/`
  - Linux: `~/.config/Tokenki/data/`
