...
var defaultCacheRatio = map[string]float64{
	...
	"claude-fable-5-1-xhigh":              0.025,
	"claude-fable-5-1-high":               0.025,
	"claude-fable-5-1-medium":             0.025,
	"claude-fable-5-1-low":                0.025,
	"claude-mythos-5":                     0.1,
...
var defaultCreateCacheRatio = map[string]float64{
	...
	"claude-fable-5-1-xhigh":              1.25,
	"claude-fable-5-1-high":               1.25,
	"claude-fable-5-1-medium":             1.25,
	"claude-fable-5-1-low":                1.25,
	"claude-mythos-5":                     1.25,
	"claude-mythos-5-1":                   1.25,
	"gpt-5.5":                             1.25,
	"gpt-5.6-sol":                         1.25,
	"gpt-5.6-terra":                       1.25,
	"gpt-5.6-luna":                        1.25,
