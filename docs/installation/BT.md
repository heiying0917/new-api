...
本文档提供使用宝塔面板 Docker 功能部署 Tokenki 的图文教程。
...
1. 在宝塔面板中创建网站目录，如 `/www/wwwroot/tokenki`
...
services:
  tokenki:
    image: tokenki/tokenki:latest
    container_name: tokenki
    restart: always
    ports:
      - "3000:3000"
    volumes:
