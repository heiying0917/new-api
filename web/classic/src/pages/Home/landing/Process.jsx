...
const Process = () => {
  ...
  const steps = [
    { n: '1', title: t('自助上传官方 Key'), desc: t('提交你的 Claude / AWS / OpenRouter / OpenAI 官方凭证,一键加密入库。') },
    { n: '2', title: t('平台智能分发'), desc: t('全球企业订单按规则分发到你的渠道,真实流量、稳定调用。') },
    { n: '3', title: t('透明实时计量'), desc: t('每笔调用按官方口径计量,成交价即时快照,账目清晰、随时可对账。') },
    { n: '4', title: t('多币种实时结算'), desc: t('按周期自动生成结算单,核对无误即刻打款,支持多币种回款。') },
  ];
  return (
